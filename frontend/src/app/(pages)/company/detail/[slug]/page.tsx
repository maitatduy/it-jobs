                    ...
                    <div className="border border-[#DEDEDE] rounded-[8px] p-[20px]">
                        <div className="flex flex-wrap items-center gap-[16px] mb-[20px]">
                            ...
                            <div className="sm:flex-1">
                                ...
                                <div className="flex items-center gap-[8px] font-[400] text-[14px] text-[#121212]">
                                    <FaLocationDot className="text-[16px]" /> Tầng 15, tòa Keangnam
                                    Landmark 72, Mễ Trì, Nam Tu Liem, Ha Noi
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-col gap-[10px]">
                            <div className="font-[400] text-[16px] text-[#A6A6A6]">
                                Mô hình công ty:
                                <span className="text-[#121212]">Sản phẩm</span>
                            </div>
                            <div className="font-[400] text-[16px] text-[#A6A6A6]">
                                Quy mô công ty:
                                <span className="text-[#121212]">151 - 300 nhân viên</span>
                            </div>
                            <div className="font-[400] text-[16px] text-[#A6A6A6]">
                                Thời gian làm việc:
                                <span className="text-[#121212]">Thứ 2 - Thứ 6</span>
                            </div>
                            <div className="font-[400] text-[16px] text-[#A6A6A6]">
                                Làm việc ngoài giờ:
                                <span className="text-[#121212]">Không có OT</span>
                            </div>
                        </div>
                    </div>
